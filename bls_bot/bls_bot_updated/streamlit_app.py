...
#             if formatted:
#                 try:
#                     # Use content_sid if available for WhatsApp template messages
#                     if content_sid:
#                         message_obj = client.messages.create(
#                             from_=f"whatsapp:{from_number}",
...
#                         )
#                     else:
#                         # Fallback to plain text message if no content_sid
#                         message_obj = client.messages.create(
#                             from_=f"whatsapp:{from_number}",
#                             body=message,
#                             to=f"whatsapp:{formatted}"
#                         )
#                     print(f"[{datetime.now()}] ✅ WhatsApp sent to: {formatted}, SID: {message_obj.sid}, Status: {message_obj.status}")
#                 except TwilioRestException as e:
#                     print(f"[{datetime.now()}] ❌ WhatsApp failed to {formatted}: {str(e)} (Code: {e.code}, Status: {e.status})")
#                 except Exception as e:
